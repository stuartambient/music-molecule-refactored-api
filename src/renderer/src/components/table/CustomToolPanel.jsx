...
const CustomToolPanel = ({
  ...
  const fields = [
    ...
    { name: 'encoder', label: 'encoder', defaultChecked: false },
    { name: 'encoderSettings', label: 'encoderSettings', defaultChecked: false },
    { name: 'encodedBy', label: 'encodedBy', defaultChecked: false },
